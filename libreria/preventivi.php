        ...
        for ($begin_a = 1; $begin_a <= $countPages; $begin_a++) {
            ...
            if ($num_rs > 0) {
                ...
                if($rowCalendario['id_professionista']<=0){
                    $sql_cliente = "SELECT calendario.id, calendario.nome, caledario.cognome, calendario.indirizzo, calendario.cap, calendario.citta, calendario.provincia FROM calendario INNER JOIN lista_preventivi
