...
var ComponentsSelectMittente = function() {

    var handleSelectMittente = function() {
        ...
        var placeholder = "Seleziona Mittente";

        $(".select_mittente, .select_mittente-multiple").select2({
            placeholder: placeholder,
            width: null
        });

        $(".select_mittente-allow-clear").select2({
            allowClear: true,
            placeholder: placeholder,
            width: null
        });
        ...
        // body > .select2-container) if _any_ of the opened Select2's parents
        // has one of these forementioned classes (YUCK! ;-))
        $(".select_mittente, .select_mittente-multiple, .select_mittente-allow-clear").on("select2:open", function() {
            if ($(this).parents("[class*='has-']").length) {
                var classNames = $(this).parents("[class*='has-']")[0].className.split(/\s+/);
