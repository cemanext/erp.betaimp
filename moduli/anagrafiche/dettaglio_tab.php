                                                        ...
                                                        <div class="portlet-body form">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane active" id="tab_prof">
                                                                    ...
                                                                    <div class="row" style="margin-bottom:10px;">
                                                                        <div class="col-md-3">
                                                                            <?=print_select2("SELECT nome as valore, nome AS nome FROM lista_professioni", $tabellaProfessionista."_txt_professione", $row_00001['professione'], "", false, 'tooltips select_professione', 'data-container="body" data-placement="top" data-original-title="PROFESSIONE"'); ?>
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <?=print_select2("SELECT sigla_province as valore, sigla_province AS nome FROM lista_province", $tabellaProfessionista."_txt_provincia_albo", $row_00001['provincia_albo'], "", false, 'tooltips select_prov_ablo', 'data-container="body" data-placement="top" data-original-title="PROVINCIA ALBO"'); ?>
