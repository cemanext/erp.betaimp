    ...
    switch ($_GET['fn']) {
        ...
        case "preventivoFirmato":
            ...
            if(!empty($row_4) and strlen($preventivo_nuovo)>0){
                ...
                $sql_41 = "INSERT INTO `lista_fatture` (`id`, `id_area`,  `sezionale`, `dataagg`, `data_preventivo`, `data_creazione`, `data_scadenza`, `id_contatto`,`id_professionista`, `id_azienda`, `id_preventivo`, `codice_preventivo`, `gestore`, `codice`, `barcode`, `causale`, `pagamento`, `importo`, `imponibile`, `sconto`, `iva`, `note`, `scrittore`, `tipo`, `stato`, `id_agente`)
                SELECT '', `id_area`,  `sezionale`, NOW(), CURDATE(), '', '', `id_contatto` , `id_professionista`, `id_azienda`, id, codice, gestore, 'xxx', '', campo_1, 'Bonifico Bancario', `importo`, `imponibile`, `sconto`, `iva`,  `note`, `scrittore`, 'Fattura', 'In Attesa di Emissione', `id_agente`
                ...
                $sql_42 = "INSERT INTO `lista_fatture_dettaglio` (`id`, `id_area`, `sezionale`, `dataagg`, `id_fattura`, `codice_fattura`, `barcode_fattura`, `id_preventivo`, `codice_preventivo`, `barcode_preventivo`, `tipo_prodotto`, `nome_prodotto`, `codice_prodotto`, `barcode_prodotto`, `id_prodotto`, `costo_prodotto`, `id_fornitore`, `costo_fornitore_prodotto`, `prezzo_prodotto`, `iva_prodotto`, `quantita`, `note`, `scrittore`, `tipo`, `stato`,  `id_professionista`, `id_azienda`)
                SELECT '', `id_area`, `sezionale`, NOW(), '$id_fattura_sql_41', 'xxx', '', `id_preventivo`, `codice_preventivo`, `barcode_preventivo`, `tipo_prodotto`, `nome_prodotto`, `codice_prodotto`, `barcode_prodotto`, `id_prodotto`, `costo_prodotto`, `id_fornitore`, `costo_fornitore_prodotto`, (`prezzo_prodotto`), `iva_prodotto`, `quantita`, `note`, `scrittore`, `tipo`, 'In Attesa di Emissione',  `id_professionista`, `id_azienda`
