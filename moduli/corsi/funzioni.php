...
function Stampa_HTML_Dettaglio_Corsi($tabella,$id){
    ...
    switch ($tabella) {
        ...
        case 'lista_corsi':
            ...
            echo '<div class="row"><div class="col-md-12 col-sm-12">';
            $sql_0001 = "SELECT id, CONCAT('<a class=\"btn btn-circle btn-icon-only red btn-outline\" href=\"cancella.php?tbl=lista_corsi_configurazioni&id=',id,'\" title=\"ELIMINA\" alt=\"ELIMINA\"><i class=\"fa fa-trash\"></i></a>') AS 'Elimina', 
            codice_corso AS 'Codice', id_classe AS 'Classe', data_inizio, data_fine, 
            crediti, durata_corso, avanzamento,  codice_accreditamento AS 'Cod. Accr.',
